...
const ContactForm = (props: { isLoadingCallback: (isLoading: boolean) => void }) => {
    ...
    useEffect(() => {
        init("user_EGP34CtqOgsskdvK7Rq5Q");
    ...
    useEffect(() => {
        ...
        const sendEmailPromise = emailjs.send("service_1wiun8r", "template_ca8d8nm", {
            nom: onSubmitEvent.nom,
            message: onSubmitEvent.comment,
            reply_to: onSubmitEvent.email
        });
        //const sendEmailPromise = new Promise((resolve, reject) => setTimeout(resolve, 2000));

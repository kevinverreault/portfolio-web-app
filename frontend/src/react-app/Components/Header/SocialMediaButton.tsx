...
import { faInstagram, faYoutubeSquare, faThreads } from '@fortawesome/free-brands-svg-icons'
...
const SocialMediaButton = (props: SocialMediaButtonProps) => {
  ...
  } else if (props.label === 'threads') {
    icon = <FontAwesomeIcon icon={faThreads} size="lg" />
    label = <span style={{ display: 'none' }}>Threads</span>
  }
